...
- Upgraded the version range of SSZipArchive dependency in
  MLKitDigitalInkRecognition from ">= 2.2.3, < 3.0" to ">= 2.5.5, < 3.0" to pull in the latest privacy manifest for it.
- Raised the minimum supported version of iOS from 12.0 to 15.5 to be compatible with the latest SSZipArchive dependencygooglemac/iPhone/MLKit/NaturalLanguage/Translate/Distribute/CHANGELOG.md.
# 2024-02-20 -- v4.0.0
